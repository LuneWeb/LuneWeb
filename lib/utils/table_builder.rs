...
taken from: https://github.com/lune-org/lune

Ported to be compatible with mlua 0.10.x
...
impl<'lua> TableBuilder<'lua> {
    ...
    */
    ...
    where
        ...
        A: FromLuaMulti,
        R: IntoLuaMulti,
        F: Fn(Lua, A) -> FR + 'static + std::marker::Send,
        FR: Future<Output = LuaResult<R>> + 'static + std::marker::Send,
    {
